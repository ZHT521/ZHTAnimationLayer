...
@implementation ZHTAnimationLayer
...
+ (CALayer *)replicatorLayer_Circle{
    ...
    animationGroup.animations = @[[ZHTAnimationLayer alphaAnimation],[ZHTAnimationLayer scaleAnimation]];
...
+ (CALayer *)replicatorLayer_Wave{
    ...
    shape.fillColor = [UIColor redColor].CGColor;
    [shape addAnimation:[ZHTAnimationLayer scaleAnimation1] forKey:@"scaleAnimation"];
...
+ (CALayer *)replicatorLayer_Triangle{
    ...
    shape.fillColor = [UIColor redColor].CGColor;
    shape.lineWidth = 1;
    [shape addAnimation:[ZHTAnimationLayer rotationAnimation:transX] forKey:@"rotateAnimation"];
...
+ (CALayer *)replicatorLayer_Grid{
    ...
    CAAnimationGroup *animationGroup = [CAAnimationGroup animation];
    animationGroup.animations = @[[ZHTAnimationLayer scaleAnimation1], [ZHTAnimationLayer alphaAnimation]];
